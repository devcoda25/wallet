...
import { Building2, Menu, Search, Bell, ChevronRight } from "lucide-react";
        ...
        <header className="sticky top-0 z-40 border-b border-slate-200 bg-white/80 backdrop-blur-md">
            <div className="mx-auto flex h-16 max-w-[1440px] items-center justify-between px-4 md:px-6">
                ...
                <div className="hidden max-w-md flex-1 px-8 md:block">
                    <div className="relative group">
                        ...
                        <input
                            ...
                            className="h-10 w-full rounded-full border border-slate-200 bg-slate-50 pl-10 pr-4 text-sm font-medium outline-none transition-all focus:border-emerald-500 focus:bg-white focus:ring-4 focus:ring-emerald-500/10 placeholder:text-slate-400"
                        />
                    </div>
                </div>
                ...
                <div className="flex items-center gap-2 sm:gap-4">
                    ...
                    <button className="flex items-center gap-2 rounded-full border border-slate-200 bg-white pl-1 pr-3 py-1 hover:bg-slate-50 transition-colors shadow-sm">
                        <div className="h-7 w-7 rounded-full bg-gradient-to-tr from-emerald-500 to-teal-400"></div>
                        <span className="hidden text-xs font-semibold text-slate-700 sm:block">{userName}</span>
