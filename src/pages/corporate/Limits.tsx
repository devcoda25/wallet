    ...
    return (
        <div className="space-y-6 p-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <h1 className="text-2xl font-bold text-gray-900">Limits & Budget</h1>
            ...
            <SectionCard title="Overall Budget Usage" subtitle="Current month">
                <div className="flex items-center justify-between mb-4">
                    <h2 className="text-lg font-semibold text-gray-900">Overall Budget Usage</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="flex items-center justify-center">
                        <div className="text-center">
                            ...
                            <p className="text-2xl font-bold text-gray-900">{formatCurrency(totalLimit - totalSpent)}</p>
                        </div>
                    </div>
                </div>
            </SectionCard>
                ...
                <SectionCard title="Budget Alerts" subtitle={`${sampleAlerts.length} active alerts`}>
                    ...
                    <div className="space-y-3">
                        {sampleAlerts.map((alert) => (
                            <div
                                key={alert.id}
                                className={`flex items-start gap-3 p-3 rounded-lg ${alert.severity === 'danger'
                            ...
                            >
                                <AlertTriangle className={`w-5 h-5 mt-0.5 ${alert.severity === 'danger'
                                    ? 'text-red-500'
                                    : alert.severity === 'warning'
                                        ? 'text-amber-500'
                                        : 'text-blue-500'
            ...
            <SectionCard title="Limits by Category" subtitle={`${filteredLimits.length} categories`}>
                <h2 className="text-lg font-semibold text-gray-900 mb-4">Limits by Category</h2>
