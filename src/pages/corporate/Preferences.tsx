                ...
                <div className="space-y-4 mt-4">
                    <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                        ...
                        <button
                            ...
                            className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${emailNotifications ? 'bg-blue-500' : 'bg-gray-300'
                                }`}
                        >
                            <span
                    ...
                    <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                        ...
                        <button
                            ...
                            className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${pushNotifications ? 'bg-blue-500' : 'bg-gray-300'
                                }`}
                        >
                            <span
                    ...
                    <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                        ...
                        <button
                            ...
                            className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${smsNotifications ? 'bg-blue-500' : 'bg-gray-300'
                                }`}
                        >
                            <span
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <label className="flex items-center gap-3 p-4 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-500">Budget limit warnings</p>
                            </div>
                        </label>
                        <label className="flex items-center gap-3 p-4 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100">
                            <input
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-500">Company policy changes</p>
                            </div>
                        </label>
                        <label className="flex items-center gap-3 p-4 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100">
                            <input
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-500">Promotions and news</p>
                            </div>
                        </label>
                    </div>
                </div>
                    ...
                    <div className="p-4 bg-gray-50 rounded-lg">
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <button
                                ...
                                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${compactView ? 'bg-blue-500' : 'bg-gray-300'
                                    }`}
                            >
                                <span
