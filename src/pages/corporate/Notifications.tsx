            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <SectionCard title="Read" subtitle="Viewed messages">
                    <div className="flex items-center gap-3 mt-4">
                        ...
                        <p className="text-3xl font-bold text-gray-900">{totalCount - unreadCount}</p>
                    </div>
                </SectionCard>
            </div>
                ...
                {filteredNotifications.length === 0 ? (
                    ...
                    <div className="space-y-2">
                        {filteredNotifications.map((notification) => (
                            <div
                                key={notification.id}
                                className={`flex items-start gap-4 p-4 rounded-lg transition-colors ${notification.read ? 'bg-white' : 'bg-blue-50'
