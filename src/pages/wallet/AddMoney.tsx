    ...
    return (
        ...
        >
            ...
            <div className="text-center">
                ...
                <div className="text-xs text-slate-500">{method.fee}</div>
            </div>
        </button>
    );
}
    ...
    return (
        <div className="flex items-center gap-3 border-b border-slate-100 py-3 last:border-0">
            ...
            <div className="flex-1 min-w-0">
                <div className="text-sm font-semibold text-slate-900">{item.method.charAt(0).toUpperCase() + item.method.slice(1)}</div>
